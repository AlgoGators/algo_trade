...
from algo_trade.risk_limits import (
    max_forecast_position_limit,
    max_leverage_position_limit,
    max_pct_of_open_interest_position_limit,
...
class TestPortfolioRisk(unittest.TestCase):
    ...
    def test_max_pct_of_open_interest_position_limit(self):
        ...
        result = max_pct_of_open_interest_position_limit(
            max_acceptable_pct_of_open_interest, open_interest
        )
