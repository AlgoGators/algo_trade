...
from . import portfolio_risk, position_risk
from .risk_functions import \
    daily_variance_to_annualized_volatility
from ._logging import CsvFormatter
...
def aggregator(
    ...
    notional_exposure_per_contract = unadj_prices.apply(lambda col: col * multipliers.loc['multiplier', col.name]).abs()
